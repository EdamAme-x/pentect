...
fn infer_kind(path: &Path) -> pentect_core::Kind {
    if path
        .file_name()
    ...
    match path
        ...
        .as_deref()
    {
        Some("json") => pentect_core::Kind::Json,
        Some("env") => pentect_core::Kind::Env,
        Some("har") => pentect_core::Kind::Har,
        _ => pentect_core::Kind::Text,
    }
}
