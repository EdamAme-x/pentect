...
pub use detect::{
    ...
    CredSweeperNativeDetector, CredSweeperNativeFinding, CredSweeperNativeStats, DecodeDetector,
    Detector, EntropyDetector, KeyValueDetector, PatternMatchDetector, PatternSpec, PemDetector,
