...
`KAS-ECC-CDH_P-192_C0`, `ALICE_secp112r1_PUB`, and `ED25519-1-PUBLIC` as
case/curve labels, not key material.
...
- Public crypto test-vector identifiers are shape-gated: NIST KAS-ECC case IDs, role+named-curve labels, and ED25519/ED448 test case labels are skipped; operational handles such as `tenant-7-trial` and `ALICE_prod_key_2026` still fire.
