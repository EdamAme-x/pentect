    ...
    items: [
      ...
      { text: sidebarLabel('Pi', 'terminal', '/brands/pi.svg'), link: '/clients/pi/' },
      {
        ...
        items: [
          ...
          { text: sidebarLabel('Aider', 'terminal', '/brands/aider.svg'), link: '/clients/aider/' },
          ...
          { text: sidebarLabel('Roo Code', 'code'), link: '/clients/roo-code/' },
          ...
          { text: sidebarLabel('Gemini CLI', 'terminal'), link: '/clients/gemini/' },
        ],
      },
