...
const sidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: sidebarLabel('Aider', 'terminal'), link: '/clients/aider/' },
      { text: sidebarLabel('Continue CLI', 'code', '/brands/continue.svg'), link: '/clients/continue/' },
      { text: sidebarLabel('Cline CLI', 'code', '/brands/cline.svg'), link: '/clients/cline/' },
      { text: sidebarLabel('Roo Code', 'code', '/brands/roo-code.svg'), link: '/clients/roo-code/' },
      { text: sidebarLabel('Zed', 'code', '/brands/zed.svg'), link: '/clients/zed/' },
      { text: sidebarLabel('Goose CLI', 'terminal', '/brands/goose.svg'), link: '/clients/goose/' },
      { text: sidebarLabel('Junie CLI', 'terminal', '/brands/jetbrains.svg'), link: '/clients/junie/' },
      { text: sidebarLabel('Gemini CLI', 'terminal', '/brands/gemini.svg'), link: '/clients/gemini/' },
